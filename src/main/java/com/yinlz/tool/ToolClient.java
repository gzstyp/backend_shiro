...
import com.yinlz.bean.PageFormData;
...
public final class ToolClient implements Serializable{
    ...
    */
    ...
    public final static boolean validateField(final HashMap<String,String> params,final String[] fields){
